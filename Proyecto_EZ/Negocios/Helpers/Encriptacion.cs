...
namespace Negocios.Helpers
{
    public class Encriptacion
    {
        ...
        /// <returns>Encriptado de sDato</returns>
        /// ***********************************************************************************************
        public static string EncriptarString(string sData, int len)
        {
            byte[] btData = Encriptar(sData, len);
        ...
        /// <returns>Encriptado de sDato</returns>
        /// ***********************************************************************************************
        public static string DesencriptarString(string sData, int len)
        {
            byte[] btData = Convert.FromBase64String(sData);

            return Desencriptar(btData, len);
        }
